...
OBJECTS	= $(PROJECT).o \
	      sysinit.o \
	      crt0.o \
	      ../../lib_teensy/cs140e-teensy-gpio.o \
	      ../../lib_teensy/cs140e-teensy-uart.o
...
TOOLPATH = /usr/local/Cellar/arm-none-eabi/4.8.3-cs170e
...
TEENSY3X_BASEPATH = /Users/christinali/Documents/Stanford/JuniorYear/WinterQtr/CS140E/Teensy3x
...
VPATH = $(TEENSY3X_BASEPATH)/common:$(TEENSY3X_BASEPATH)/lib_teensy

				
#  List of directories to be searched for include files during compilation
INCDIRS  = -I$(GCC_INC)
INCDIRS += -I$(TEENSY3X_INC)
INCDIRS += -I$(TEENSY3X_BASEPATH)/lib_teensy
INCDIRS += -I.
